...
return function(mode)
    ...
    {Name="Dumpling",Anm2="800.000_dumpling.anm2",HP=7,StageHP=2,Champion=true,CollisionDamage=1,CollisionMass=3,CollisionRadius=13,Friction="0.95",ShadowSize=12,NumGridCollisionPoints=12,Type=800,GridCollision="walls",HasFloorAlts="true",Portrait=0,Reroll="true",},
    ...
    {Name="Echo Bat",Anm2="828.000_echo bat.anm2",HP=20,Champion=true,CollisionDamage=1,CollisionMass=14,CollisionRadius=13,ShadowSize=18,NumGridCollisionPoints=12,Type=200,Variant=2407,GridCollision="walls",Portrait=9,Reroll="true",},
